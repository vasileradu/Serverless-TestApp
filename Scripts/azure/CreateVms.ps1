 # monolith
 az vm create --resource-group TestApp --name "monolith" --location "westeurope" --image "vm-image-monolith" --size Standard_B8ms --admin-username "TestAppAdmin" --admin-password "Pa55word!Pa55word!" --storage-sku Standard_LRS --nsg "TestApp-ngs" --vnet-name "TestApp-vnet" --subnet "TestApp-subnet" --private-ip-address 10.0.0.4 --public-ip-address "IP_Monolith" --tags "persistance=onetime"
 
 az vm create --resource-group TestApp --name "monolith" --location "westeurope" --image win2016datacenter --size Standard_B8ms --admin-username "TestAppAdmin" --admin-password "Pa55word!Pa55word!" --storage-sku Standard_LRS --nsg "TestApp-ngs" --vnet-name "TestApp-vnet" --subnet "TestApp-subnet" --private-ip-address 10.0.0.4 --public-ip-address "IP_Monolith" --tags "persistance=onetime"
 
 # service.analysis
 az vm create --resource-group TestApp --name "analysis" --location "westeurope" --image "vm-image-service-analysis" --size Standard_A2m_v2 --admin-username "TestAppAdmin" --admin-password "Pa55word!Pa55word!" --storage-sku Standard_LRS --nsg "TestApp-ngs" --vnet-name "TestApp-vnet" --subnet "TestApp-subnet" --private-ip-address 10.0.0.5 --public-ip-address "IP_Analysis" --tags "persistance=onetime"
